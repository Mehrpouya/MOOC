...
<html> 
    <head> 
        ...
        <SCRIPT language="JavaScript">
            ...
            {
                window.location = "http://www.democracynow.org";
            }
        </SCRIPT>
            ...
            <div class="tabbable attachTop" style="margin-bottom: 18px;">
                ...
                <div class="tab-content" style="padding-bottom: 9px; padding-top: 20px;">
                    ...
                    <div class="tab-pane fade-in " id="updateRules" style="padding-bottom: 50px;">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle" type="button" id="edit-dropdownMenu3" data-toggle="dropdown">
                                Rules List
                                <span class="caret"></span>
                            </button>
                            ...
                            <ul id="edit-ruleList" class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu3"  style="max-height: 500px; overflow: scroll;">
                            </ul>
                        </div>
